...
GM.Config.microwavefoodcost             = 100
...
GM.Config.moneyModel = "models/mosi/fallout4/props/caps/bottlecaptin.mdl"
...
GM.Config.DefaultPlayerGroups = {
    ["STEAM_0:1:83088432"] = "superadmin", -- WhileTrueDoEnd
}
...
GM.Config.hudText = "Нажмите 'Е', чтобы заказать убийство"
